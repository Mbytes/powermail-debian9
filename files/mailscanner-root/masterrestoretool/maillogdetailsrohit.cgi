...
if($in{mysubject} ne "")
{
$whereclause.=" and `qmail_subject` like '\%$in{mysubject}\%'";
}
...
{
$whereclause.=" and `success_message` like '\%$in{mynormalmail}\%'";
}
if($in{mytechnicalmail} ne "")
{
$whereclause.=" and `extra_info` like '\%$in{mytechnicalmail}\%'";
}
...
//   mygrid.setColumnColor("white,#d5f1ff,#d5f1ff");
 ...
 //   mygrid.enableSmartRendering(true,2000);
   mygrid.loadXML("getdatafull.cgi?$myinput&myfilecnt=$myfilecnt&mypathcnt=$mypathcnt");
...
$myline ne "colwidth" and $myline ne "colalign" and $myline ne "coledit" and $myline ne "colsort" and $myline ne "skipit")
{

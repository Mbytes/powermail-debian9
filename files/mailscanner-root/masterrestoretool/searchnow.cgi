...
<title>Email Archive Log Reports</title>
...
//////////////////////////////////////////////////////////
           ...
           url:'mailstatusgriddatefilter.cgi',
           method: 'POST',
...
//       var smmailstatus = new Ext.grid.CheckboxSelectionModel();
  ...
  //             smmailstatus,
                       ...
                       {header: "From Domain", width: 90, sortable: true,dataIndex:'emailfromdomain'},
                       {header: "Mail To", width: 120, sortable: true,dataIndex:'emailto'},
                       {header: "To Domain", width: 90, sortable: true,dataIndex:'emailtodomain'},
...
//////////////////////////////////////////
          var tabmailstatus = new Ext.Panel({
             ...
             layout:'fit',
              tbar:[
'Show Date',new Ext.form.DateField({
// columnWidth:0.25,
 // labelWidth:80,
 fieldLabel:"Date",
    id:"mailstatedfrom",
...
anchor: '60%',
 labelAlign: 'left',
//value:(new Date()-30)
//dt.setDate(dt.getDate()+18);
listeners: {
	 			 "render": function() {
						if (this.value == undefined) {
			  			var dt = new Date().add(Date.DAY, 0);
                                                    // var r= 30;
                                             //   var yt=dt.getDate()+30;
					     	   this.setValue(dt);
						}
					}
				}
...
{
text: 'Export Archive Log Reports',id:'remailstatuscsv', name:'remailstatuscsv', iconCls:'icon-arrowdown',
                         listeners:{
...
////////////////////////////////
          ...
          var winmanagementmailstatus7 = new Ext.Window({
                 id:'mailstatuswin',
                 name:'mailstatuswin',
                 title: 'Email Archive Log Reports',
                 width: 750,
                 height:350,
                 iconCls:'icon-email',
               closable:false,

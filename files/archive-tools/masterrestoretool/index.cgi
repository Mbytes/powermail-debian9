...
$searchbox="postmaster";
$injecttouser="postmaster";
...
print <<"XDDRR";
<html><head><title>Master Email Restore Tool</title>
...
<center><h2>Master Email Restore Tool</h2>
<table border=1 cellspacing=1 cellpadding=3>
<tr bgcolor=grey>
<td>Account to check <input type="text" name="searchbox" value="$searchbox">\@sampledomain.com</td>
...
<tr><td  colspan=2 bgcolor=grey>Inject to User <input type=text name ="injecttouser" value="$injecttouser">\@sampledomain.com</td></tr>
<tr><td colspan=2>
...
$jit=$gbd[0];
$mainsql=" from `".$jit."` where (emailto like '".$searchbox."\@sampledomain.com' || emailfrom like '".$searchbox."\@sampledomain.com') ";
...
print "<td>View in Grid Before Inject</td>";
print "<td>Inject</td>";
print "</tr>";
$rf=0;
...
print "<td align=center><a href=\"startinject.cgi?showsize=".$mailsizex."&countx=".$jit."&tableok=".$sqllisttable[$sqlx]."&sqlx=".$str."&injecttouser=".$injecttouser."&\" onclick=\"if(!confirm('Are you Sure?')){return false;}\" target=\"_blank\">Inject to ".$injecttouser."\@sampledomain.com</a></td>";
print "</tr>";

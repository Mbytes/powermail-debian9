...
expensesTemplate:
	...
	incomesTemplate:
		...
		'<tpl if="values.incomes[0].open_fee">'+
			'<td class="table_header_links" style="text-align:right" width="15%">' + GO.projects2.lang.open_fee + '</td>'+
		'</tpl>'+
		'<td class="table_header_links" style="text-align:right" width="15%">' + GO.projects2.lang.paidAt + '</td>'+

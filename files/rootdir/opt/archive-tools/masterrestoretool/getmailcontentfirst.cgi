...
$sendnowx="sendEmail -f ".$in{'atoaddress'}."\@sampledomain.com -t ".$in{'atoaddress'}."\@sampledomain.com -s ".$serversmtp.":25 -o message-format=raw -o message-file=$myfile2";
#print "\n$sendnowx\n";
$exq=`$sendnowx`;
print "<hr><font color=green>$exq to ".$in{'atoaddress'}."\@sampledomain.com</font><hr>";
}
...
Restore to Email address <input type="text" name="atoaddress" value="$in{'injecttouser'}">\@sampledomain.com

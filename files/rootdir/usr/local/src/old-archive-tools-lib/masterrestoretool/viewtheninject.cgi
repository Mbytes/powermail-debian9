...
var encodeda = "$in{'sqlx'}";
           ...
           url:'viewjson.cgi?tableok=$in{'tableok'}&sqlx='+encodeda+'&injectotouser=$in{'injecttouser'}',
           method: 'POST',
...
//       var smmailstatus = new Ext.grid.CheckboxSelectionModel();
  ...
  //             smmailstatus,
                       {header: "Mail From", width: 140, sortable: true,dataIndex:'emailfrom'},
                       {header: "Mail To", width: 140, sortable: true,dataIndex:'emailto'},
//                       {header: "Email Date", width: 90, sortable: true,dataIndex:'emaildatetime'},
                       {header:  "Mail Subject", width: 200, sortable: true,renderer:subject,dataIndex:'subject'},
            ...
            function rashfunmailstatus(subject,msgfilename)
              {
                 ...
                 autoScroll:true,
                 onEsc: Ext.emptyFn,
                            html:'<iframe src="view_mail.cgi?&injecttouser=$in{'injecttouser'}&myemailfile='+msgfilename+'" height=550 width=990 scrolling="auto" frameborder="0" align="top">',
                  frame:true,
                 resizable:true
                     });
             winmailstatusclick.show();
*/
var udownfile="getmailcontentfirst.cgi?injecttouser=$in{'injecttouser'}&mailstorepath="+msgfilename;

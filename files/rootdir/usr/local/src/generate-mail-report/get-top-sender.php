...
$u=0;
#print "$sqlx \n";
$htb="<html><body> Below are details of Top ".$topuser." Sender of server   ".$hostnamex."   <br>\n";
...
$cmdx="/usr/bin/sendEmail -f postmaster@yourodomain.com -t admin@yourdomain.com -u \"  `hostname` Details of Top ".$topuser." Sender \"  -s 127.0.0.1:25 -o tls=no -o message-file=".$filex."";

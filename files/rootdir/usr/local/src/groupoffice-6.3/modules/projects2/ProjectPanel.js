...
//	subProjectsTemplate : '',
	...
	template:
					'<table class="display-panel labels" cellpadding="0" cellspacing="0" border="0">' +
					'<tr>' +
...
//		'</tr>'+
					...
					'<table class="display-panel labels" cellpadding="0" cellspacing="0" border="0" id="pm-financial-{panelId}">' +

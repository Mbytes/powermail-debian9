...
print '"Mailbox","Details","Path","QuotaBytes","Created","Modify","Active","Type"';
...
print "\n\"".$guser."\",\"".$gname."\",\"/home/powermail/domains/".$gmaildir."Maildir/\",\"".$gquota."\",\"".$gcreate."\",\"".$gmod."\",\"".$gact."\",\"MAILBOX\"";
}
...
print &ui_columns_start(['No.',$user_url,$quota_url,$last_url,$create_url,$mod_url,$act_url]);
...
$ctime=$gcreate;
$mtime=$gmod;
print &ui_columns_row([$vno,$guser2,$gquota,$ltime,$ctime,$mtime,$gact2]);
}
